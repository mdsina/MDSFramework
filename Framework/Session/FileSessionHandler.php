 ...
 */
class FileSessionHandler extends \SessionHandler implements SpecialInterface {
    ...
    /**
     * Get sha1 from useragent, ip and request time
     *
     * @return string
     */
    public function hash()
    {
        return sha1(Request\User::getUserAgent() . Request\User::getIp() . Request\Request::getRequestTime());
    }
